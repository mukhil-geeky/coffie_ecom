...
class OrderBlocState extends Equatable {
  ...
  const OrderBlocState({this.isLoading, required this.counter});
  ...
  static OrderBlocState initial() {
    return OrderBlocState(isLoading: false, counter: 0);
  }
  ...
  OrderBlocState copyWith({bool? isLoading, int? counter}) {
  ...
  OrderBlocState copyWithNull({bool isLoading = false, int? counter}) {
    return OrderBlocState(
